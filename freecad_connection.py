...
class FreeCADConnection:
    ...
    def _get_connection_methods(self, prefer_method: Optional[str] = None) -> List[str]:
        ...
        """
        all_methods = [self.CONNECTION_SERVER, self.CONNECTION_BRIDGE, self.CONNECTION_MOCK]
    ...
    def _connect_server(self) -> bool:
        ...
        try:
            ...
            response = self._send_server_command({
                "type": "ping"
            })
    ...
    def _execute_bridge_command(self, command_type: str, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def create_box(self, 
                  ...
                  width: float = 10.0, 
                  height: float = 10.0,
                  document: Optional[str] = None) -> Optional[str]:
        """
