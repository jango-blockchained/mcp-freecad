...
class TestPrimitiveToolProvider:
    ...
    @pytest.mark.asyncio
    async def test_create_box_success(
        self, primitive_tool_provider, mock_freecad, test_utilities
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_box_with_defaults(
        self, primitive_tool_provider, mock_freecad
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_cylinder_success(
        self, primitive_tool_provider, mock_freecad, test_utilities
    ):
