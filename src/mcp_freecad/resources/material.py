...
class MaterialResourceProvider(ResourceProvider):
    ...
    async def get_resource(self, uri: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        if len(path_parts) < 1 or path_parts[0] != "materials":
            raise ValueError(f"Invalid URI format: {uri}, expected 'cad://materials/...'")
    ...
    def _mock_available_materials(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "count": 5,
            "materials": [
                {"name": "Steel", "category": "Metal", "description": "Standard steel material"},
                {"name": "Aluminum", "category": "Metal", "description": "Standard aluminum alloy"},
                {"name": "PLA", "category": "Plastic", "description": "Standard PLA plastic for 3D printing"},
                {"name": "Wood", "category": "Natural", "description": "Generic wood material"},
                {"name": "Glass", "category": "Ceramic", "description": "Standard glass material"}
            ],
        ...
        return {
            ...
            "categories": [
                ...
                },
                {
                    "name": "Plastic",
                    "materials": [
                        {"name": "PLA", "description": "Standard PLA plastic for 3D printing"},
                        {"name": "ABS", "description": "Acrylonitrile Butadiene Styrene plastic"}
                    ]
                },
                {
                    "name": "Natural",
    ...
    def _load_material_library(self) -> Dict[str, Dict[str, Any]]:
        ...
        try:
            ...
            if hasattr(self.app, "getResourceDir"):
                ...
                user_material_dir = os.path.join(self.app.getUserAppDataDir(), "Material")
