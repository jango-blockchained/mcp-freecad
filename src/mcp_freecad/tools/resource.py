...
class ResourceProvider(ABC):
    ...
    @abstractmethod
    async def get_resource(self, resource_id: str, params: Dict[str, Any]) -> ResourceResult:
        """
        Get a resource.
    ...
    def format_result(self, status: str, content: Optional[Any] = None, mime_type: Optional[str] = None, error: Optional[str] = None) -> ResourceResult:
        """
