    ...
    async def _measure_distance(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if point1 and point2:
                ...
                if (
                    isinstance(point1, list)
                    and isinstance(point2, list)
                    and len(point1) == 3
                    and len(point2) == 3
                ):
                    ...
                    return {
                        "status": "error",
                        "message": "Invalid point format. Expected [x, y, z]",
                    }
                ...
                if not obj1:
                    return {
                        "status": "error",
                        "message": f"Object not found: {object1}",
                    }
                if not obj2:
                    return {
                        "status": "error",
                        "message": f"Object not found: {object2}",
                    }
                ...
                if not hasattr(obj1, "Shape") or not hasattr(obj2, "Shape"):
                    return {
                        "status": "error",
                        "message": "Objects must have shapes for distance measurement",
                    }
                ...
                if subobject1:
                    if subobject1.startswith("Edge"):
                        ...
                        if edge_idx < 0 or edge_idx >= len(shape1.Edges):
                            return {
                                "status": "error",
                                "message": f"Invalid edge index: {subobject1}",
                            }
                        ...
                        if face_idx < 0 or face_idx >= len(shape1.Faces):
                            return {
                                "status": "error",
                                "message": f"Invalid face index: {subobject1}",
                            }
                        ...
                        if vertex_idx < 0 or vertex_idx >= len(shape1.Vertexes):
                            return {
                                "status": "error",
                                "message": f"Invalid vertex index: {subobject1}",
                            }
                ...
                if subobject2:
                    if subobject2.startswith("Edge"):
                        ...
                        if edge_idx < 0 or edge_idx >= len(shape2.Edges):
                            return {
                                "status": "error",
                                "message": f"Invalid edge index: {subobject2}",
                            }
                        ...
                        if face_idx < 0 or face_idx >= len(shape2.Faces):
                            return {
                                "status": "error",
                                "message": f"Invalid face index: {subobject2}",
                            }
                        ...
                        if vertex_idx < 0 or vertex_idx >= len(shape2.Vertexes):
                            return {
                                "status": "error",
                                "message": f"Invalid vertex index: {subobject2}",
                            }
        ...
        try:
            ...
            if vector1 and vector2:
                ...
                if (
                    ...
                    return {
                        "status": "error",
                        "message": "Invalid vector format. Expected [x, y, z]",
                    }
                ...
                if not hasattr(obj1, "Shape") or not hasattr(obj2, "Shape"):
                    return {
                        "status": "error",
                        "message": "Objects must have shapes for angle measurement",
                    }
                ...
                if subobject1.startswith("Edge"):
                    ...
                    return {
                        "status": "error",
                        "message": f"Invalid subobject type: {subobject1}. Use Edge or Face",
                    }
                ...
                if subobject2.startswith("Edge"):
                    ...
                    return {
                        "status": "error",
                        "message": f"Invalid subobject type: {subobject2}. Use Edge or Face",
                    }
