...
class ErrorEventProvider(EventProvider):
        ...
        try:
            ...
            if hasattr(self.app, 'Gui') and hasattr(self.app.Gui, 'getMainWindow'):
                try:
                    ...
                    console = self.app.Gui.getMainWindow().findChild("QTextEdit", "Report view")
    ...
    def report_error(self, error_message: str, error_type: str = "manual", details: Dict[str, Any] = None):
        """
