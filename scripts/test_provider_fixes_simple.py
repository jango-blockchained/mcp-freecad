...
def test_loading_flag_implementation():
    ...
    providers_widget_path = os.path.join(
        os.path.dirname(__file__), "freecad-ai/gui/providers_widget.py"
    )
...
def test_provider_selector_refresh():
    ...
    selector_widget_path = os.path.join(
        os.path.dirname(__file__), "freecad-ai/gui/provider_selector_widget.py"
    )
