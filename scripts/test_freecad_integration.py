...
try:
    ...
    try:
        ...
        print(
            f"   ✅ Dependency manager working - checked {len(dependencies)} dependencies"
        )
        ...
        if manager.check_dependency("aiohttp"):
            ...
            if missing_sub_deps:
                ...
                try:
                    ...
                    print(
                        f"   ⚠️ Automatic sub-dependency installation failed: {install_e}"
                    )
            else:
    ...
    try:
        ...
        print(
            f"   📊 AI providers system working - {available_count}/{len(providers)} providers available"
        )
        ...
        if available_count == 0:
            ...
            try:
                ...
                print(
                    f"   ⚠️ AI provider dependency installation failed: {ai_install_e}"
                )
