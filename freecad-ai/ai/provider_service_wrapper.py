            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            from ai.provider_integration_service import (
                    ...
                    logging.info(
                        "Provider service imported from ai/provider_integration_service.py"
                    )
                ...
                if provider_service_imported:
                    ...
                    logging.warning(
                        "Could not import provider service - using fallback"
                    )
                    self.provider_service = None
            except Exception as e:
